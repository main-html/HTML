...
find . -type f -name "*.avif" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'image/avif' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --gzip-local-all --content-encoding "gzip" --content-type "image/avif" --cache-control "public, max-age=31536000"
find . -type f -name "*.webp" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'image/webp' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --gzip-local-all --content-encoding "gzip" --content-type "image/webp" --cache-control "public, max-age=31536000"
find . -type f -name "*.jpg" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'image/jpeg' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --gzip-local-all --content-encoding "gzip" --content-type "image/jpeg" --cache-control "public, max-age=31536000"
find . -type f -name "*.jpeg" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'image/jpeg' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --gzip-local-all --content-encoding "gzip" --content-type "image/jpeg" --cache-control "public, max-age=31536000"
find . -type f -name "*.png" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'image/png' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --gzip-local-all --content-encoding "gzip" --content-type "image/png" --cache-control "public, max-age=31536000"
find . -type f -name "*.mp4" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'video/mp4' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --content-type "video/mp4" --cache-control "public, max-age=31536000"
find . -type f -name "*.ogg" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'audio/ogg' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --content-type "audio/ogg" --cache-control "public, max-age=31536000"

# Upload HTML Pages
find . -type f -name "*.json" -newer "$publish_config" -exec file --mime-type {} + | sed 's/^\.\///' | grep 'application/json' | awk -F': ' '{print $1}' | xargs -I {} gcloud storage cp "{}" $gsutil_uri/{} --gzip-local-all --content-encoding "gzip" --content-type "application/json; charset=utf-8" --content-language "$content_language" --cache-control "public, max-age=86400"
